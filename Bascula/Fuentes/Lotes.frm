...
MemVar_3.ListIndex = CargaCombo(MemVar_3, 3)
MemVar_4.ListIndex = CargaCombo(MemVar_4, 4)
MemVar_5.ListIndex = CargaCombo(MemVar_5, 5)
MemVar_51.ListIndex = CargaCombo(MemVar_51, 6)
MemVar_52.ListIndex = CargaCombo(MemVar_52, 7)
...
Private Sub MemVar_5_KeyPress(KeyAscii As Integer)
    KeyAscii = 0
End Sub

Private Sub MemVar_51_KeyPress(KeyAscii As Integer)
    KeyAscii = 0
End Sub

Private Sub MemVar_52_KeyPress(KeyAscii As Integer)
    KeyAscii = 0
End Sub
...
While Not Em.EOF
    Set Nodx = oTree.Nodes.Add("A" & Em!Mina, tvwChild, "A" & Format(Em!IdLote, "000000"), Format(Em!IdLote, "000000") & " - " & Em!Manto & " - " & Em!Bloque & " - " & Em!DesOperador, 14)
    Em.MoveNext
Wend
