...
xSql = "Select Top 1 * From Bascula "
oT.Open xSql, Conn, 2, 3, 1
If Not oT.EOF Then oT.MoveLast
...
On Error GoTo Recover
    ...
    If (xPesoV = 0) Then
        If MsgBox("Desea Cerrar el Tiquete", vbYesNo, "Cerrado de Tiquete-Estado='AC'") = vbYes Then
           Conn.Execute ("Update Bascula Set Estado='AC', FechaVacio='" & Format(Now, "dd/MM/yyyy hh:mm:ss") & "' Where IdTiquete=" & MemVar_1)
        End If
    End If
